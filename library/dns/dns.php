...
<br><br>
Need to verify if you set up your cname record correctly for using google apps or to just check your CNAME record.
<div style=background-color:silver>
                <b>DNS tool cname</b><br>
                <form action=/resolve_dns.php method=post>
                <input type=text name=ip>
                <select name=dns_options>
                        <option value=a>A </option>
...
<div style=background-color:silver>
                ...
                <select name=dns_options>
                        ...
                        <option value=txt>TXT </option>
                        <option value=aaaa>AAAA </option>
                        <option selected value=hinfo>Hinfo </option>
                        <option value=srv>SRV </option>
                        <option value=all>All </option>
                        <option value=any>Any </option>
                </select>
...
<div style=background-color:silver>
                ...
                <select name=dns_options>
                        ...
                        <option value=ns>NS </option>
                        <option value=soa>SOA </option>
                        <option selected value=ptr>PTR </option>
                        <option value=txt>TXT </option>
                        <option value=aaaa>AAAA </option>
                        <option value=hinfo>Hinfo </option>
                        <option value=srv>SRV </option>
